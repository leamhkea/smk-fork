...
const KurvPopover = () => {
  const { billetter, billetSum, emptyKurv, isKurvVisible, hideKurv } =
    useBookingStore((state) => ({
      billetter: state.billetter,
      billetSum: state.billetSum(),
      emptyKurv: state.emptyKurv,
      isKurvVisible: state.isKurvVisible,
      hideKurv: state.hideKurv,
    }));
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <Link href="/ordreoversigt" onClick={hideKurv}>
