    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col mt-4">
          ...
          <p>
            {art.content_description?.[0] || "Værket har ingen beskrivelse"}
          </p>
        ...
        <div className="flex flex-col mt-4">
          ...
          <p>
            {art.literary_reference?.[0] ||
              "Værket har ingen litterær reference"}
          </p>
        </div>
        <div className="flex flex-col gap-1 mt-3">
          <p className="bold">Relateret information</p>
          <p>
            {art.related_objects?.[8] ||
              "Kunstneren har ingen relaterede  informationer"}
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-1">
        ...
        <LongDescriptions
          description={
            ...
            "Kunstneren har ingen beskrivelse"
          }
        />
      </div>
      <div className="flex flex-col gap-1">
